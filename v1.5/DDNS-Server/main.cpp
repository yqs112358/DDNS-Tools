...
int main(int argc, char *argv[])
{
    ...
    QCommandLineOption logOption(QStringList() << "o" << "output"
                                 ,QCoreApplication::translate("main","Output the log into <file>")
    ...
    {
        qDebug() << "数据库文件不存在！正在释放...";
        QFile fBakDB(DB_BAK);
        QFile fReleaseDB(DB_PATH);
